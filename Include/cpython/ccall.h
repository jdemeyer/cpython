...
/* Base signature: one of 4 possibilities, exactly one must be given.
   ...
   - the valid combinations with CCALL_KEYWORDS | CCALL_DEFARG give precisely
     the range 0, ..., 11. This allows the compiler to implement the main
     switch statement in PyCCall_FastCall() using a jump table.
